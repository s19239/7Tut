    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Task4()
        {
            ...
            var res4 = Emps.Where(emp => emp.Salary == (Emps.Max(emp => emp.Salary)));
        ...
        public void Task6()
        {
            var res = Emps.Join(Depts, r => r.Deptno, p => p.Deptno, (r, p) => new { r.Ename, r.Job, p.Dname }).ToList();
        ...
        public void Task7()
        {
            var res = Emps.GroupBy(emp => emp.Job).Select(emp => new { EmployeeJob = emp.Key, Count = emp.Count() }).ToList();
        ...
        public void Task10()
        {
            ...
            var o = new[] { new { Name = "No Value", Job = "null" } }; //The properties of anonymous types are read-only and cannot be initialized with a null, so excluded HireDate
            var res = o.Union(Emps.Select(emp => new { Name = emp.Ename, emp.Job }).ToList()).ToList();
        ...
        public void Task11()
        {
            var res = Emps.Aggregate((emp0, emp1) => emp0.Salary > emp1.Salary ? emp0 : emp1).ToString();
        ...
        public void Task12()
        {
            var res = from emp in Emps
                      ...
                      select new
                      {
                          FirstName = emp.Ename,
                          emp.Job,
                          DepartmentNumber = dept.Deptno

                      }.ToString();

            //SelectMany
            var res1 = Emps.SelectMany(t1 => Depts.Select(t2 => new {
                FirstName = t1.Ename,
                t1.Job,
                DepartmentNumber = t2.Deptno
            })).ToList();
